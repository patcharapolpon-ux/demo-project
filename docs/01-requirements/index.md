...
รายการ requirement ทั้งหมดเรียงตามลำดับที่สร้างอยู่ใน [[backlog|backlog.md]] และสรุปเป็นฟีเจอร์พร้อมจัดลำดับความสำคัญแบบ MoSCoW ไว้ที่ [[feature-list|feature-list.md]]
